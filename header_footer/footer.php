<footer class="blog-footer bg-dark text-light">
    ...
    <script src="dist/js/js/dataTables.bootstrap.min.js"></script>
    <script src="dist/js/bootstrap.min.js"></script>
    <!-- Just to make our placeholder images work. Don't actually copy the next line! -->
    <script src="dist/vendor/holder.min.js"></script>

    <!-- THIS IS AJAX WORKING WITH DATABASE METHODS OF JQUERY! -->
    <script src="main_js/dashboard_ajax.js"></script>

    <!-- THIS IS AJAX WORKING WITH DATABASE METHODS OF JQUERY! -->
    <script src="main_js/add_post_ajax.js"></script>

    <!-- THIS IS AJAX WORKING WITH DATABASE METHODS OF JQUERY! -->
    <script src="main_js/manage_admins_ajax.js"></script>
    <script src="main_js/uncomment.js"></script>
    <script src="main_js/comment_ajax.js"></script>

    <!-- THIS IS JAVASCRIPTS OF VALIDATION FORMS IN BOOTSTRAP! -->
    <script src="main_js/validat_bostrap_form.js"></script>
    <!-- THIS IS JAVASCRIPTS OF VALIDATION FORMS IN BOOTSTRAP! -->
