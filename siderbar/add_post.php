...
$message ="";
?>
       <h4 class="display-4 text-center">Add Post</h4>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="profile_image">
                              <div id="preview"><img src="img/filed.png" width="100px"/></div><br>
                         ...
                         <div id="show_Content" style="display:none;">
                            ...
                            <img width = "60px" src="uploads/"><span id="imageView"></span></p>
                            <hr>
        ...
        <div class="row mx-3 mt-2">
            <div class="col-sm-md-lg-12 md-offset-2">
                ...
                <input style="float: right" type="button" class="btn btn-success" id="addPost" value="add Post">
