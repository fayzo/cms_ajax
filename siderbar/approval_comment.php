...
$message ="";
?>
       <h4 class=" display-4 text-center">An Approval Comment : <span class="bg-success rounded text-white">ON</span></h4>
                    ...
                    <div class="modal-body">
                        <div id="edit_comment">
                         ...
                         <div id="show_comment" style="display:none;">
                            ...
                            <img width = "60px" src="uploads/"><span id="imageView_comment"></span></p>
                            <hr>
