                    ...
                    <form method="post">
                       <span id="response_settings"></span>
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="username" value="<?php echo $row['username'];?>" placeholder="UserName">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="email" id="email" value="<?php echo $row['email'];?>"  aria-describedby="helpId"
                                placeholder="Email">
                        </div>
