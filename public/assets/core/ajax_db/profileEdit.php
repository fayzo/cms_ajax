...
if(!empty($_FILES['picture']['name'])){
    ...
    $uploadDir = $_SERVER['DOCUMENT_ROOT'].'Blog_nyarwanda_CMS/public/assets/image/users_profile_cover/';
    ...
    $path= $_SERVER['DOCUMENT_ROOT'].'Blog_nyarwanda_CMS/public/assets/image/users_profile_cover/'.$fileName.'';
...
if(!empty($_FILES['cover_picture']['name'])){
    ...
    //Load JavaScript function to show the upload status
    $path= $_SERVER['DOCUMENT_ROOT'].'Blog_nyarwanda_CMS/public/assets/image/users_profile_cover/'.$coverName.'';
