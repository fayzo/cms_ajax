...
?>
 <h4 class="display-4 mb-2 text-center">DASH-BOARD</h4>

      <div class="d-flex flex-wrap row-hl text-center " style="background:#f4f4f4;">
         <div class="item-hl bg-primary border-dark rounded p-2 mr-2 my-2">
          <h1>N0 OF USERS</h1>
          <h1 class="text-white"><?php echo $total_users ;?></h1>
          </div>
         <div class="item-hl bg-secondary border-dark rounded  p-2 mr-2 my-2">
         <h1>N0 OF POSTS</h1>
         <h1 class="text-white"><?php echo $total_post ;?></h1>
         </div>
         <div class="item-hl bg-success border-dark rounded p-2 mr-2 my-2">
         <h1>N0 OF Comments</h1>
         <h1 class="text-light"><?php echo  $totalcomment ;?></h1>
         </div>
         <div class="item-hl bg-info border-dark rounded p-2 mr-2 my-2">
         <h1>N0 OF Approvals <br>Comments</h1>
         <h1 class="text-light"><?php echo $total_approval ;?></h1>
          </div>
         <div class="item-hl bg-warning border-dark rounded p-2 mr-2 my-2">
         <h1>N0 OF Un-Approvals <br> Comments</h1>
         <h1 class="text-light"><?php echo $total_unapproval ;?></h1>
         </div>
         <div class="item-hl border-dark rounded p-2 mr-2 my-2" style="background-color:#3b5998">
         <h1>N0 OF Visitors</h1>
         <h1 class="text-light">34</h1>
         </div>
         <div class="item-hl border-dark rounded py-2 my-2" style="background-color:#d34836">
         <h1>N0 OF Visitors <br> per Year</h1>
         <h1 class="text-light">3134</h1>
         </div>
       </div>
